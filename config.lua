Config                  = {}
Config.DynamicWeather   = true -- Set this to false if you don't want the weather to change automatically every 55 minutes.
...
Config.NewWeatherTimer  = 55 -- Time (in minutes) between each weather change   default: 10
